...
# Dunn index
dunn_k_hd <- dunn( dist(umap_embed), kmeans_cluster)
...
cut_a_hdgnes <- cutree(agnes_cluster, k = 3)
...
# Dunn index
dunn_a_hd <- dunn( dist(umap_embed), cut_a_hdgnes)
...
# AGNES clustering
dist_hd_data_umap <- dist(umap_embed, method= "euclidean")
agnes_cluster_umap_embed  <- hclust(dist_hd_data_umap, method = "ward.D2" )  
cut_a_hdgnes <- cutree(agnes_cluster, k = 3)
silhouette_a_hd <- silhouette(cut_a_hdgnes, dist(umap_embed))
silhouette_a_hd <- as.matrix(silhouette_a_hd)
silhouette_a_hd <- silhouette_a_hd[,3]
