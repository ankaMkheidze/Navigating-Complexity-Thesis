...
# Dunn index
dunn_k_means_sr_nodr <- dunn( distance = NULL, clusts_nodr_sr, Data = swiss_data)
...
dunn_agnes_sr_nodr <- dunn( dist(swiss_data), cut_agnes_sr_nodr)
...
# Dunn index
dunn_k_means_sr_pca <- dunn( distance = NULL, clusters_pca_sr, Data = sr_pca)
...
dunn_agnes_sr_pca <- dunn( dist(sr_pca), cut_agnes_sr_pca)
...
# Dunn index
dunn_k_means_sr_tsne <- dunn( distance = NULL, clusters_tsne_sr, Data = tsne_sr)
...
dunn_agnes_sr_tsne <- dunn( dist(tsne_sr), cut_agnes_sr_tsne)
...
# Dunn index
dunn_k_means_sr_umap <- dunn( distance = NULL, kmeans_cluster_sr_umap, Data = umap_sr)
...
#scatterplot3d(swiss_data, color=rainbow(4)[cut_agnes_umap_sr], main = "agnes after UMAP sr")
...
dunn_agnes_sr_umap <- dunn( distance = NULL, cut_agnes_umap_sr, Data = umap_sr)
